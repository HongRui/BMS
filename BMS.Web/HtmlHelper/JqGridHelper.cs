...
//", HttpRuntime.AppDomainAppVirtualPath+"/scripts");
        ...
        {
            string str = @"<table id='list{0}' ></table>
...
if(document.body.clientWidth>1024){{WIDTH=1000;}}
...
shrinkToFit :true,
    ...
    gridComplete:GridComplete
            ...
            if (isPager)
            {
                pager = string.Format("rowNum: PAGEROW,rowList: [15, 25, 50,100,10000],pager:jQuery('#pager{0}'),", name);
