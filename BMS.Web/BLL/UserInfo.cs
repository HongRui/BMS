                ...
                if (HttpContext.Current.Session["User"] == null)
                {
                    ...
                    lock (lockobj)
                    {
                        ...
                        using (OUContext db = new OUContext())
                        {
                            ...
                            {
                                int code;
                                if (int.TryParse(HttpContext.Current.User.Identity.Name, out code) == false) return null;
                            ...
                            else
                            {
                                ...
                                systemuser = (from o in db.SystemUsers where o.WorkNO == ad select o).FirstOrDefault();
                                if (systemuser == null)
                                    throw new Exception("找不到用户资料" + HttpContext.Current.User.Identity.Name);
                            }
