...
namespace OUDAL
{
    public class AccessLog
    {
        ...
        public static void AddLogAndSave(OUContext db, string person, int id, string logClass, string logAction, string info)
        {
        ...
        public static void AddLogAndSave(OUContext db, string person, string code, string logClass, string logAction, string info)
        {
            AccessLog a = new AccessLog();
            a.Code = code;
            a.AccessClass = logClass;
        ...
        public static void AddLog(OUContext db, string person, string code, string logClass, string logAction, string info)
        {
            AccessLog a = new AccessLog();
            a.Code = code;
            a.AccessClass = logClass;
